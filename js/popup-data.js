export const popupData = [
    {
    img: 'img/box1-img.png',
    title: 'Blue Plate Mayonnaise',
    ...
    {
    img: 'img/box2-img.png',
    title: 'Integrative Health Products: High Quality Products for a Better Quality of Life',
    discription: 'Editorial project management, content direction, proofreading & copy editing, copywriting, and recipe standardization for new website of the beloved regional favorite'

    },
    {
    img: 'img/box3-img.png',
    title: 'Luzianne Iced Tea-Family Owned Since 1902',
    discription: 'Editorial project management, content direction, proofreading & copy editing, copywriting, and recipe standardization for new website of the beloved regional favorite'
